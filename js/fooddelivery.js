...
// ----------------------------
const menuList = [
  { nama: "Nasi Goreng Spesial", harga: 20000, img: "img/makanan/1.nasi goreng.jpg", desc: "Nasi goreng khas Nusantara dengan telur dan ayam suwir." },
  { nama: "Soto Ayam Lamongan", harga: 18000, img: "img/makanan/2. Soto Ayam Lamongan.jpg", desc: "Kuah gurih, ayam empuk, disajikan dengan koya dan sambal." },
  { nama: "Rawon Daging", harga: 25000, img: "img/makanan/3. rawon daging.jpg", desc: "Sup daging khas Jawa Timur dengan kuah hitam pekat." },
  { nama: "Mie Goreng Jawa", harga: 19000, img: "img/makanan/4. mie goreng jawa.jpg", desc: "Mie goreng dengan bumbu kecap manis dan sayur segar." },
  { nama: "Ayam Bakar Madu", harga: 24000, img: "img/makanan/5. ayam bakar madu.jpg ", desc: "Ayam bakar dengan olesan madu dan sambal terasi." },
  { nama: "Ikan Bakar Jimbaran", harga: 30000, img: "img/makanan/6. Ikan Bakar Jimbaran.png", desc: "Ikan segar dibakar dengan bumbu khas Bali." },
  { nama: "Rendang Padang", harga: 27000, img: "img/makanan/7. rendang padang.jpg", desc: "Daging sapi dimasak lama hingga empuk dengan santan dan rempah." },
  { nama: "Nasi Liwet Sunda", harga: 22000, img: "img/makanan/8. nasi liwet sunda.jpg", desc: "Nasi gurih dengan ikan asin dan sambal terasi." },
  { nama: "Bakso Malang", harga: 15000, img: "img/makanan/9. bakso malang.jpeg", desc: "Bakso kenyal, tahu, dan pangsit goreng dalam kuah kaldu gurih." },
  { nama: "Gado-Gado Betawi", harga: 16000, img: "img/makanan/10. gado gado betawi.jpg", desc: "Sayur segar dengan bumbu kacang dan telur rebus." },
];
